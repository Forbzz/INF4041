<?php
// src/Esiea/BlogBundle/DataFixtures/ORM/BlogFixtures.php

namespace Esiea\BlogBundle\DataFixtures\ORM;
...
use Esiea\BlogBundle\Entity\Blog;
...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $manager)
  {
    ...
    $blog1->setTags('symfony2, php, paradise, guidblog');
    ...
    $blog2->setTags('pool, leaky, hacked, movie, hacking, guidblog');
    ...
    $blog3->setTags('misdirection, magic, movie, hacking, guidblog');
    ...
    $blog4->setTags('grid, daftpunk, movie, guidblog');
    ...
    $blog5->setTags('binary, one, zero, alive, dead, !trusting, movie, guidblog');
